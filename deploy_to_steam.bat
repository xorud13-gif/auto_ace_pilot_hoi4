...
copy /y "%~dp0version.dll" "!STEAM_DIR!\version.dll" > nul
if !ERRORLEVEL! neq 0 (
...
copy /y "%~dp0common\decisions\categories\ace_auto_assign_categories.txt" "!STEAM_DIR!\common\decisions\categories\" > nul
copy /y "%~dp0common\decisions\ace_auto_assign_decisions.txt" "!STEAM_DIR!\common\decisions\" > nul
copy /y "%~dp0common\on_actions\ace_auto_assign_on_actions.txt" "!STEAM_DIR!\common\on_actions\" > nul
...
copy /y "%~dp0localisation\korean\ace_auto_assign_l_korean.yml" "!STEAM_DIR!\localisation\korean\" > nul
